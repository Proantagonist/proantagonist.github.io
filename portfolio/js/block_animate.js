...
(function() {
	...
	mywebsite = (function() {
		...
		mywebsite.prototype.animateHomeimg = function() {
			...
			return jQuery("#home .welcome_block").waypoint(function() {
				return new Animo({
					...
					el: jQuery("#home .welcome_block p"),
					duration: 900,
					easing: "easeOutBack",
					delay: 700,
					template: {
		...
		mywebsite.prototype.animateAbout = function() {
			var _this = this;
			return jQuery("#about .center_block_effect").waypoint(function() {
				return new Animo({
					el: jQuery("#about .center_block_effect"),
					duration: 600,
					delay: 100,
					template: {
						translateY: [50, 0, "%"],
					...
					el: jQuery("#about .services_item.scale_effect"),
					easing: "easeOutBack",
					delay: 500,
					gap: -80,
					template: {
		...
		mywebsite.prototype.animatePortfolio = function() {
			var _this = this;
			return jQuery("#portfolio .opacity").waypoint(function() {
				return new Animo({
					el: jQuery("#portfolio .opacity"),
					duration: 600,
					delay: 500,
					template: {
						opacity: [0, 1]
		...
		mywebsite.prototype.animateContact = function() {
			...
			return jQuery("#contact").waypoint(function() {
				return new Animo({
					el: jQuery("#contact .contact_info"),
					duration: 500,
					delay: 300,
					template: {
						opacity: [0, 1],
					...
					el: jQuery(".contact_form input, .contact_form textarea"),
					duration: 500,
					delay: 1900,
					gap: -85,
					easing: "easeOutBack",
